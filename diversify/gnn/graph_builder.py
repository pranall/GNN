...
class GraphBuilder:
    """
    Thin wrapper around convert_to_graph() for your GNN pipeline.
    """
    ...
    def build_graph(self, sensor_data: torch.Tensor):
        """
        sensor_data: Tensor of shape [num_nodes, timesteps, features]
        Returns a tuple (edge_index, edge_attr)
        """
        data = convert_to_graph(
            sensor_data,
            adjacency_strategy=self.method,

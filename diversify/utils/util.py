...
def get_args():
    ...
    parser.add_argument('--use_gnn', action='store_true', help='Enable GNN processing')
    parser.add_argument('--node_features', type=int, default=16, help='Features per sensor node')
    parser.add_argument('--gnn_hidden', type=int, default=64, help='GNN hidden dimension')
    ...
    parser.add_argument('--layer', type=str, default="bn", choices=["ori", "bn", "ln"])
